...
Users must be added to the `video` group to use it.
...
include GUIs for configuring them, or they can be configured manually.
...
Configuration for older applications is available and described as well.
