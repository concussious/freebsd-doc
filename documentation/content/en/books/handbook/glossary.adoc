...
[[drm-glossary]]
man:drm[7], Direct Rendering Manager::
A kernel module allowing client applications direct access to the graphical hardware via the Direct Rendering Infrastructure.
+
See man:drm[7].
